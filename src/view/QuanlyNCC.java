...
//        pane_bg.setBackground(new Color(215, 220, 230));
    ...
    public void Search(){
        ...
        btn_Search.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                System.out.println("Da bam tim kiem NCC");
                try{
    ...
    public void table_NCC(){
        ...
        table_NCC.getColumnModel().getColumn(4).setCellRenderer(new TableActionCellRender(new Color(234,247,255), new Color(255, 237, 243)));
        table_NCC.getColumnModel().getColumn(4).setCellEditor(new TableActionCellEditor(event, new Color(234,247,255), new Color(255, 237, 243)));
